...
<div class="container">
	...
	?>
			<div class="row mt-4 mb-2 style="background:blue; ">
				<div class="col">
				...
				<li class="list-group-item">
					<div class="row">
						...
						<div class="col text-center">
							gfd
							<a href="play.php?song=<?php echo ($s['song_id']); ?>" title=""><img width="100" src="./play.png" alt="nfg"></a>
						</div>
					</div>
				</li>
			...
			?>
				<li class="list-group-item">
					<div class="row">
						...
						<div class="col text-center">
							<a href="play.php?song=<?php echo ($s['song_id']); ?>" title=""><img width="60" class="mt-3" src="play.png" alt=""></a>
						</div>
					</div>
				</li>
